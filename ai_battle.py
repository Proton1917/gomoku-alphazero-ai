...
try:
    ...
    print("Warning: train module not found. AI modes will be disabled.")
    AI_AVAILABLE = False    
...
board_size = train.board_size
class Config:
    num_workers=5
    num_games=5
    num_simulations=100
    name1 = "model_4090_trained.pth"
    name2 = "model_4090_trained.pth"
    Model1 = train.Model(name1)
    Model2 = train.Model(name2)
